APPR_TYPE_044_recode <- function(nbi_data){
  #' Recoding kind of material of the approach span and type of design to make it understandable without the coding guide
  #'
  #' @param nbi_data A csv file using the NBI coding system and format
  #'
  #' @return Descriptions of the kind and type of the approach span in words
  #' @export
  nbi_data$APPR_KIND_044A <- dplyr::recode(nbi_data$APPR_KIND_044A,
                                                ...
                                                "0" = "Other")
  nbi_data$APPR_TYPE_044B <- dplyr::recode(nbi_data$APPR_TYPE_044B,
                                                "01" = "Slab",
