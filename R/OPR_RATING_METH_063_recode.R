OPR_RATING_METH_063_recode <- function(nbi_data){
  #' Recoding the method used to determine operating rating to make it understandable without the coding guide
  #'
  #' @param nbi_data A csv file using the NBI coding system and format
  #'
  #' @return the load rating method used to determine operating rating in words
  #' @export
  nbi_data$OPR_RATING_METH_063 <- dplyr::recode(nbi_data$OPR_RATING_METH_063,
