LatLong_conversion <- function(nbi_data) {
  ...
  nbi_data$LAT_016 <- format(as.double(LatH+(LatM/60)+(LatS/360000)), digits = 3, scientific = 3)
  ...
  nbi_data$LONG_017 <- format(as.double(LonH+(LonM/60)+(LonS/360000)), digits = 3, scientific = 3)
